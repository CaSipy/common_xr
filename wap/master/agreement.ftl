<#include "../inc/head_base.ftl"/>
	...
	<#include "../inc/head_var.ftl"/>
	    ...
	    <script src="${json_config.domain_url}/${json_config.project_name_common}/${json_config.folder_name}/src/js/agreement.js?ver=12"></script>
...
<div class="fix_containner">
    ...
    <a href="enter.do" class="weui-btn weui-btn_primary width90 bg-qblue" style="margin: auto; margin-top: 2rem;" >下一步</a>
</div>
