 <#include "../inc/head_base.ftl"/>
	...
	<script src="${json_config.domain_url}/${json_config.project_name_common}/${json_config.folder_name}/src/js/userMoney_incharge.js?ver=201704302026"></script>
					...
					<div class="weui-cells cancle mar-t2" ng-show="is_input_money">
						<div class="weui-cell">
							<div class="weui-cell__bd text-font5 bank-inputBrb" ng-click="keyboard()">
								￥<input class="weui-input hx-abr-none width90 input-size" id="money" type="text" disabled ng-model="money">
							</div>
						</div>
					</div>
				</div>
