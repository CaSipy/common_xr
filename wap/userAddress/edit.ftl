<#include "../inc/head_base.ftl"/>
	...
	<body class="bg-qgray" ng-controller="ctrl"  ng-app="app">
		<div>
			<!--头部-->
			<header class="back-header weui-flex  bg-white header_bBor">
				...
				<h1 class="back-header-h1 flex_item4 sc-text-blue">编辑地址</h1>
				<a class="flex_item1 header-right sc-text-blue"></a>
			</header>
			<div class="fix_containner">
			<!--主体部分-->
			<section class="weui-cells weui-cells_form mar-t0 cancle bg-qgray">
				<!--收货人-->
				<article class="weui-cells mar-t0">
					<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label text-font3">联系人</label></div>
						<div class="weui-cell__bd">
							<input class="weui-input text-r sc-text-gray text-font3" type="text" value="" ng-model="receiver_name">
						</div>
					</div>
				</article>
				<!--手机号码-->
				<article class="weui-cells mar-t0">
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input class="weui-input text-r sc-text-gray text-font3" type="number" value="" pattern="[0-9]*"  ng-model="receiver_phone">
						</div>
					</div>
				</article>
				<!--选择地址-->
				<article class="weui-cells mar-t0">
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">														
							<input id="start" class="weui-input text-r text-font3 sc-text-gray" type="text"  value=""  ng-model="area" readonly="">
				...
				<article class="pad-all3 mar-t4">
					<a id="saveEdit" href="javascript:;" class="weui-btn bg-qblue width90 margin-auto text-font4" ng-click="edit(id)">保存</a>
				</article>
			</section>
			</div>
		</div>
...
<script src="${json_config.domain_url}/${json_config.project_name_common}/${json_config.folder_name}/src/js/addPlace.js" type="text/javascript" charset="utf-8"></script>
<!--
