	...
	<script src="${json_config.domain_url}/${json_config.project_name_common}/${json_config.folder_name}/src/js/getorderinfo.js?ver=20170614" type="text/javascript" charset="utf-8"></script>
		...
		<section>
					...
					<div class="weui-panel__bd commodity pad-t0 pad-b0">
						<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg pad-all0 weui-flex commodity">
							...
							<div class="commodity_showHei flex_item2 pad-l4" style="padding-top: 2rem;">
								<h4 class="text-weight text-font4 bc-text-header" ng-bind="orderStatus"></h4>
								<p class="weui-media-box__desc text-font2 bc-text-header mar-t1 mar-b2">
									<span>服务时间：<i ng-bind="service_time"></i></span>
								</p>
							</div>
			...
			<section>
				...
				<article>
							...
							<div class="weui-cell weui-cell_access pad-t1 pad-b1 cIndex-figure" href="javascript:;">
								...
								<div class="weui-cell__bd mar-l2">
									<p class="text-font3 weui-flex">
										<span class=" mar-r2 flex_item3">客户：<b class="text-font4" ng-bind="contacts"></b></span>
										<a href="tel:{{contacts_number}}" class="text-font3 flex_item2 text-r" ng-bind="contacts_number"></a></p>
									<p class="text-font2 sc-text-tab mar-t1">服务地址 :
										<span ng-bind="service_address"></span>
									</p>
								</div>
							</div>
						</div>
					...
					<figure>
						<div class="weui-cells cancle mar-t0" style="border-bottom:.05rem solid #F4F4F4">
							<div class="weui-cell weui-cell_access pad-t1 pad-b1" href="javascript:;" style="height: 2rem;">
								<div class="weui-cell__hd"><img src="${json_config.oss_common_url}/wap/images/xr/icon_user.png" alt="" style="width:20px;margin-right:.5rem;display:block"></div>
								<div class="weui-cell__bd mar-l2">
									<p class="text-font3 weui-flex">
										<span class=" mar-r2 flex_item3">师傅：<b class="text-font4" ng-bind="master_name"></b></span>
										<a href="tel:{{master_mobile}}" class="text-font3 flex_item2 text-r" ng-bind="master_mobile"></a>
									</p>
								</div>
							</div>
						</div>
							    ...
							    <div class="weui-panel__bd commodity">
									<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg pad-all1 pad-r0">
										<div class="weui-media-box__hd commodity_img">
											<img class="weui-media-box__thumb" src="{{json.detail.icon_img}}" ng-src="{{json.detail.icon_img}}">
										</div>
										<!--完成状态-->
										<div class="weui-media-box__bd" name="accomplish">
											<h4 class="text-weight text-font2 text-astrict showLine-2"><b  ng-bind="deal_name"></b></h4>
										
											<p class="weui-media-box__desc text-font2 mar-t2">
												<span class="bc-text" name="price">￥:<i class="text-font3" ng-bind="total_price"></i></span>
											</p>
											<p class="text-font3 text-r width100 commodity_num">x<b ng-bind="order_deal_number"></b></p>
										</div>
									</a>
								</div>
						    </div>
							...
							<div class="weui-uploader">
								...
								<div class="weui-uploader__bd">
									<ul class="weui-uploader__files" id="uploaderFiles">
										<li class="weui-uploader__file" style="background-image:url({{json.detail.pic1_img}})"></li>
										<li class="weui-uploader__file" style="background-image:url({{json.detail.pic2_img}})"></li>
										<li class="weui-uploader__file" style="background-image:url({{json.detail.pic3_img}})"></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="weui-panel__bd">
						<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
							...
							<div class="weui-media-box__bd">
								...
								<p class="weui-media-box__desc text-font2" ng-bind="json.detail.desc"></p>
							</div>
						</a>
					</div>
				</article>
				<article class="weui-panel weui-panel_access mar-t0" ng-if="json.value_added.pay_status==2">
					<div class="weui-panel__bd">
						<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
							<div class="weui-media-box__hd userSimg">
								<img class="weui-media-box__thumb userSimg" src="${json_config.oss_common_url}/wap/images/xr/mes.png">
							</div>
							<div class="weui-media-box__bd" >
								<h4 class="weui-media-box__title text-font4">增值服务说明</h4>
				...
				<article class="mar-t3 pad-b5">
					<div class="text-font2 pad-l5 pad-r5 pad-t2 pad-b2 bg-white">
						<p class="weui-flex sc-text-tab">
							...
							<span class="flex_item1 text-r" ng-bind="order_deal_number"></span>
						</p>
						<p class="weui-flex sc-text-tab">
							<span class="flex_item1 text-l">订单发布时间</span>
							<span class="flex_item1 text-r" ng-bind="order_create_time"></span>
						</p>
						<p class="weui-flex sc-text-tab">
							<span class="flex_item1 text-l">订单完成时间</span>
							<span class="flex_item1 text-r" ng-bind="order_end_time"></span>
						</p>
						<p class="weui-flex sc-text-tab" ng-if="json.detail.is_value_added==1">
						...
						<p class="weui-flex text-font3">
							...
							<!--<span class="flex_item1 text-r sc-text-warning text-font2 text-weight3">￥<b class="text-font4" ng-bind="(json.detail.real_price*json.detail.number+json.detail.value_added_price)"></b></span>-->
							<span class="flex_item1 text-r sc-text-warning text-font2 text-weight3">￥<b class="text-font4" ng-bind="json.detail.single_price*json.detail.number+json.value_added.payment_money"></b></span>
						</p>
						<p></p>
					</div>
				</article>
