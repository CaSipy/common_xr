 <#include "../inc/head_base.ftl"/>
	...
	<script src="${json_config.domain_url}/${json_config.project_name_common}/${json_config.folder_name}/src/js/userMoney_withdraw.js?ver=${json_config.system_static_version}"></script>
		...
		<div class="fix_containner">
			<div class="star-con width92 margin-auto bg-white pad-b3 box-top">
				...
				<div class=" bg-white pad-b1 pad-t1 pad-l2">
					...
					全部佣金:<b class="text-weight" ng-bind="json.user_finance[class_name+'1']"></b>,
					可提佣金:<b class="text-weight" ng-bind="json.user_finance[class_name]"></b>,
