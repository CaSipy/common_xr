	...
	<script type="text/javascript" src="${json_config.domain_url}/${json_config.project_name_common}/${json_config.folder_name}/src/js/masterDeteil.js?ver=201706082034" charset="utf-8"></script>
</html>
